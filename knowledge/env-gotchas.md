...
| 2026-09-22 | スキルは並べるほど選べなくなる | 各スキルの説明文は常時コンテキストに載る。29 本で約7,800文字あり、"Covers A, B, C" 式の列挙が互いに重なると、どれを読むべきか判断できなくなる | 書庫に置いて入口 1 枚から引く。説明文は「いつ使うか」だけを短く。並べてよいのは、題目を見て 1 つに決まるものだけ |
